...
and the yellow circles show the user’s fixations - the radius of each circle is directly proportional to the duration of its corresponding fixation.

Given fixations and aois are added as a Appendix(Assignment-3).txt file
